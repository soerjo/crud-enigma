...
class ProductForm extends Component {
  ...
  render() {
    const { form } = this.props;
    const formulir = { ...this.state };
    // console.log("isi kesalahan form", form);
    console.log("State: ", formulir);
            ...
            <Card className="shadow">
              ...
              <CardBody>
                <Form onSubmit={this.handleSubmit}>
                  ...
                  <Button disabled={!formulir.submitEnable} type="submit">
                    Submit
                  </Button>
                </Form>
              </CardBody>
